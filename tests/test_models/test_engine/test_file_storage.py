...
class TestFileStorage(unittest.TestCase):
    ...
    def test_get(self):
        ...
        for key in keys:
            cls, id = key.split(".")
            obj = storage.get(classes.get(cls), id)
            self.assertEqual(
                classes.get(cls).__name__,
    ...
    def test_count(self):
        ...
        FileStorage._FileStorage__objects = new_dict
        storage.save()
        s_count = storage.count()
        self.assertEqual(count, s_count)
        for cls, value in classes.items():
            count = storage.count(classes.get(cls))
